...
# 投资机构
# 爬虫地址https://www.itjuzi.com/investfirm
url = config.get("spiderAPI", "investmentsSpider")

# mongodb链接信息
myclient = pymongo.MongoClient("mongodb://localhost:27017/")
mydb = myclient["dataSet"]
mycol = mydb["itjuziInvestments"]
...
def getInfoByPageNum(pageNum, headers=headers0):
    payload = "{\"pagetotal\":7182,\"total\":0,\"per_page\":20,\"page\":%s,\"scope\":\"\",\"sub_scope\":\"\",\"round\":\"\",\"prov\":\"\",\"city\":\"\",\"status\":\"\",\"sort\":\"\",\"selected\":\"\"}" % pageNum
    try:
        # headers = getHeaders()
